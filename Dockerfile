...
# Build images
FROM openjdk:11-jre-slim-bullseye AS mysql
...
FROM openjdk:11-jre-slim-bullseye AS mariadb
...
FROM openjdk:11-jre-slim-bullseye AS postgresql
...
FROM openjdk:11-jre-slim-bullseye AS mysql-cjk
...
FROM openjdk:11-jre-slim-bullseye AS mariadb-cjk
...
FROM openjdk:11-jre-slim-bullseye AS postgresql-cjk
