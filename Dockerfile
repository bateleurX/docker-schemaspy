...
# Build images
FROM eclipse-temurin:8-jre-jammy AS mysql
...
FROM eclipse-temurin:8-jre-jammy AS mariadb
...
FROM eclipse-temurin:8-jre-jammy AS postgresql
...
FROM eclipse-temurin:8-jre-jammy AS mysql-cjk
...
FROM eclipse-temurin:8-jre-jammy AS mariadb-cjk
...
FROM eclipse-temurin:8-jre-jammy AS postgresql-cjk
